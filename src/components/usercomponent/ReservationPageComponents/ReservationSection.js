...
function ReservationSection() {
  ...
  const handleCheckAvailability = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://localhost/api/Reservation/check-availability', body);
  ...
  const handleCreateReservation = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://localhost/api/Reservation/create-reservation', body);
